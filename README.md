...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-apdnu2g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-apdnu2g.containers.anotherwebservice.com/
...
```
git clone git@github.com:randev4/container-apdnu2g.git
cd container-apdnu2g
```
...
```
docker attach container-apdnu2g
```
